"""
API routes for yatra registration management (V2 - Redesigned).
...
from app.services.yatra_registration_service_v2 import YatraRegistrationServiceV2
...
def create_registration(
    ...
    try:
        service = YatraRegistrationServiceV2(db)
